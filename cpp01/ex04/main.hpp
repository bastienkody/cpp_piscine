...
#define FILE_TOO_BIG "The file size is bigger (or equal to) than the std::string.max_size(). The program\
will not be able to write anything to the replacement file for conformity and safety reasons"
